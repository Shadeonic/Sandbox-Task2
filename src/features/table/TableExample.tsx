...
const initialRows: React.ReactNode[][] = [
  ["Summer Sale", "Announcement bar", "2025-12-08", "123", "45", "3", "Active", "Edit/Delete"],
  ["Winter Sale", "Popup", "2025-11-01", "67", "12", "1", "Inactive", "Edit/Delete"],
  ["Spring Sale", "Banner", "2025-10-15", "89", "34", "5", "Active", "Edit/Delete"],
];
...
export const TableExample = () => {
  ...
  const newRows: React.ReactNode[][] = [
    [`Offer ${page}-1`, "Announcement bar", "2025-12-08", "100", "20", "2", "Active", "Edit/Delete"],
    [`Offer ${page}-2`, "Popup", "2025-12-09", "80", "15", "1", "Inactive", "Edit/Delete"],
  ];

  setRows(newRows);
  setOfferCount(50); // например, всего 50 записей на сервере
};
  ...
  const filteredRows: React.ReactNode[][] = [
    [`Result for ${query}`, "Banner", "2025-12-10", "120", "30", "4", "Active", "Edit/Delete"],
  ];
